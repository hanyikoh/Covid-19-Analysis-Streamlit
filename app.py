...
if question_num == "Question 1":
    ...
    st.markdown('''
    ## **Qeustion 2**
    ## States that exhibit strong correlation with Pahang and Johor.
    ''')
    ...
    st.markdown('''
    ## **Qeustion 4**
    ##  Models (regression/classification) that performs well in predicting the daily cases for Pahang, Kedah, Johor, and Selangor.
    ''')
